...
const Contact = () => {
  const [state, handleSubmit] = useForm("xkgbyozg"); // ID de ejemplo - necesitas crear tu cuenta en Formspree
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            >
              ...
              <button
                type="submit"
                className={`w-full py-3 px-4 rounded-md font-semibold transition-all duration-300 ${state.submitting
