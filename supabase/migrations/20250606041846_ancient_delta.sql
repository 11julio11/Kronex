/*
  ...
  1. New Tables
    - stripe_customers: Links Supabase users with Stripe customers
    - stripe_subscriptions: Stores subscription information
    - stripe_orders: Stores one-time payment information
  
  2. Views
    - stripe_user_subscriptions: Easy access to user subscription data
    - stripe_user_orders: Easy access to user order history
